...
namespace ShopAPIs {
  ...
  export const signInWithEmail =
    (client: ShopAPIClient) => (data: ShopSchemas.EmailSignInRequest) => {
      const requestPayload = {
        ...data,
        csrfmiddlewaretoken: client.getCSRFToken() ?? "",
      };
      return client.post<
        ShopSchemas.UserSignedInStatus,
        ShopSchemas.EmailSignInRequest
  ...
  export const signInWithSNS =
    ...
    async (socialSignInInfo: ShopSchemas.SocialSignInRequest) => {
  ...
  export const signOut = (client: ShopAPIClient) => async () => {
    try {
      await client.delete<ShopSchemas.UserSignedInStatus>(
  ...
  export const retrieveUserInfo = (client: ShopAPIClient) => async () => {
    try {
      const response = await client.get<ShopSchemas.UserSignedInStatus>(
        "authn/social/browser/v1/auth/session"
      );
  ...
  export const listProducts =
    (client: ShopAPIClient) => (qs?: ShopSchemas.ProductListQueryParams) =>
   ...
   * @returns 현재 장바구니 상태
   */
  export const appendItemToCart =
    (client: ShopAPIClient) => (data: ShopSchemas.CartItemAppendRequest) =>
      client.post<ShopSchemas.Order, ShopSchemas.CartItemAppendRequest>(
        "v1/orders/cart/products/",
        data
      );
  ...
  export const removeItemFromCart =
    (client: ShopAPIClient) => (data: { cartProductId: string }) =>
      client.delete<ShopSchemas.Order>(
  ...
  export const prepareOneItemOrder =
    (client: ShopAPIClient) => (data: ShopSchemas.OneItemOrderRequest) =>
      client.post<ShopSchemas.Order, ShopSchemas.OneItemOrderRequest>(
        "v1/orders/single/",
        data
      );
   ...
   */
  export const listOrders = (client: ShopAPIClient) => () =>
    client.get<ShopSchemas.Order[]>("v1/orders/");

  /**
   * 결제 완료된 주문 내역에서 특정 상품을 환불 시도합니다.
   */
  export const refundOneItemFromOrder =
    (client: ShopAPIClient) => (data: ShopSchemas.OneItemRefundRequest) =>
      client.delete<void>(
   ...
   */
  export const refundAllItemsInOrder =
    (client: ShopAPIClient) => (data: { order_id: string }) =>
  ...
  export const patchOrderOptions =
    (client: ShopAPIClient) =>
    async (data: ShopSchemas.OrderOptionsPatchRequest) =>
      client.patch<
        ShopSchemas.Order,
        ShopSchemas.OrderOptionsPatchRequest["options"]
      >(
