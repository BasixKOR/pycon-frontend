...
const SectionTextEditor: React.FC<SectionTextEditorPropType> = ({
  ...
  return <Stack direction="row" spacing={2} sx={{ width: "100%", height: "100%", maxWidth: "100%" }}>
    <Stack sx={{ flexGrow: 1, width: "50%" }}>
      ...
      />
      <Button size="small" onClick={onInsertNewSection} startIcon={<Add />}>여기에 섹션 추가</Button>
    </Stack>
...
const SectionEditorField: React.FC<SectionEditorPropType> = ({
  ...
  return <Stack direction="row" sx={{ flexGrow: 1, width: "100%", height: "100%", maxWidth: "100%" }}>
    <SectionTextEditor
      disabled={disabled}
...
export const AdminCMSPageEditor: React.FC = ErrorBoundary.with(
  ...
  Suspense.with(
    ...
    () => {
      ...
      const [editorState, setEditorState] = React.useState<AdminCMSPageEditorStateType>({ sections: initialSections, tab: 0 });
      ...
      return <AdminEditor app="cms" resource="page" id={id} extraActions={[openOnSiteButton]} afterSubmit={onSubmit}>
        <br />
        <Divider />
        <br />
        <Stack direction="row" spacing={2} sx={{ width: "100%", height: "100%", maxWidth: "100%" }}>
          ...
          <Stack sx={{ width: "100%", height: "100%", maxWidth: "100%" }}>
            <Button size="small" onClick={insertNewSection(0)} startIcon={<Add />}>맨 처음에 섹션 추가</Button>
            {
