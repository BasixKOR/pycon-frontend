...
export const getDefaultSnackOption: (v: VariantType) => OptionsObject = (v) => ({ variant: v, anchorOrigin: { vertical: 'bottom', horizontal: 'center' } })
...
export const addErrorSnackbar = (error: Error) => {
  ...
  addSnackbar(
    <Stack>
      에러가 발생했습니다, 콘솔을 확인해주세요.<br />
      문제가 지속되면, 홈페이지팀에 콘솔 내용과 함께 문의해주세요!<br />
