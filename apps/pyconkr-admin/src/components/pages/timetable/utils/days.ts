import { EventSchema, RoomScheduleSchema } from "@frontend/common/schemas/backendAdminAPI";
import { eachDayISO, isoDateOf } from "@frontend/common/utils";
import { DateTime } from "luxon";

// 이벤트 기간 + 스케줄에 등장하는 날짜를 합쳐 Day 탭 목록(ISO date)을 만든다.
export const computeDays = (event: EventSchema | null, schedules: RoomScheduleSchema[]): string[] => {
