...
export const SignOutPage: React.FC = () => {
  ...
  return <Stack sx={{ width: "100%", height: "100%", minHeight: "100%", maxHeight: "100%", flexGrow: 1, py: 2 }} justifyContent="center" alignItems="center">
    <Typography variant="h5">정말 로그아웃하시겠습니까?</Typography>
    <br />
    <Button variant="contained" onClick={handleSignOut} disabled={signOutMutation.isPending} startIcon={<Logout />}>로그아웃</Button>
  </Stack>;
}
