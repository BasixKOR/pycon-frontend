...
namespace ShopAPIs {
   ...
   * SNS로 로그인합니다.
   */
  export const signInWithSNS = (client: ShopAPIClient) => async (
    socialSignInInfo: ShopSchemas.SocialSignInRequest
  ) => {
   ...
   */
  export const patchOrderOptions = (client: ShopAPIClient) => async (
    data: ShopSchemas.OrderOptionsPatchRequest
  ) =>
